...
async def handle_link(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # would appear in the group instead of the bot DM. The picker must always
    # be in the bot DM so the user can tap a topic button privately.
